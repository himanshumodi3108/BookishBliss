...
const Navbar = () => {
  ...
  return (
    <header className='w-full bg-transparent fixed tp-0 left-0 right-0 transition-all ease-in duration-300'>
      <nav className={`py-4 lg:px-24 px-24 ${isSticky ? "sticky top-0 left-0 right-0 bg-blue-300" : ""}`}>
        ...
        <div className={`space-y-4 px-4 mt-16 py-7 bg-blue-700 ${isMenuOpen ? "block fixed tp-0 right-0 left-0" : "hidden"}`}>
          {
